...
CREATE TABLE orders_optimized (
    ...
    CONSTRAINT chk_status 
        CHECK (status IN ('pending', 'confirmed', 'cancelled', 'expired', 'confirmed_config')),
...
-- 添加RLS策略（如果需要）
-- ALTER TABLE orders_optimized ENABLE ROW LEVEL SECURITY;
...
-- 输出创建成功信息
SELECT 
    'orders_optimized表创建完成！' as message,
