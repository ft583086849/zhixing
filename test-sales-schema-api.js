...
async function testSalesSchemaAPI() {
  console.log('🔍 开始测试销售分佣系统数据库结构调整API...');
  
  try {
    // 调用销售分佣系统数据库结构调整API
    console.log('📡 调用销售分佣系统数据库结构调整API...');
    const response = await axios.post('https://zhixing-seven.vercel.app/api/update-sales-schema', {}, {
      headers: {
